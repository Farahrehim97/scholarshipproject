                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="code.php" method="POST">
                            ...
                            <div class="mb-3">
                                <label>Faculty ID</label>
                                <input type="text" name="id" id="id" class="form-control" onkeyup="unamecheck()" onblur="unamecheck()">
                            </div>
                            <div class="mb-3">
   ...
   foreach($query_run as $faculty)
    {
        print($faculty);
     ?>
        var idval=<?= $faculty['uname']; ?>;
      
     if(id==idval)
     {
     document.getElementById("id").style.border = "2px solid #F91721";
    }
    else
    {
