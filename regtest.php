            ...
            <div class="form second">
                <div class="details address">
                    ...
                    <div class="fields">
                        <div class="input-field">
                            <label>IFSC</label>
                            <input type="text" name="ifsc" id="ifsc"   placeholder="Enter your IFSC code" required  >
                        </div>
                        <div class="input-field">
